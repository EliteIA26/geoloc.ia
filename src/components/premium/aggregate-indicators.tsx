  ...
  return (
    <div className="space-y-2.5">
      <div className="flex items-baseline justify-between">
        <h2 className="text-sm text-muted-foreground">Departamentos por salud</h2>
          ...
          return (
            <li key={it.nombre}>
              <button
                ...
                className={`glass-panel w-full p-3 text-left transition-colors ${
                  isSelected
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  <span className="flex min-w-0 items-center gap-2">
                    <span
                      ...
                      aria-hidden
                    />
                    <span className="truncate text-sm text-[var(--foreground)]">{it.nombre}</span>
                  </span>
                ...
                <p className="mt-1 pl-3.5 text-[12px] text-muted-foreground">{vegetationSentence[status]}</p>
              </button>
            </li>
          );
        })}
