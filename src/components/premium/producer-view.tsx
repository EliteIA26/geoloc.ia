...
export default function ProducerView() {
  ...
  return (
    <div className="bg-background text-foreground flex h-full">
      ...
      <ResizableAside>
        <div>
          <p className="text-[11px] text-muted-foreground">Productor</p>
          <h2 className="text-base text-[var(--foreground)]">Mi finca · Aimogasta</h2>
          {sat?.ndviTrend && (
        ...
        {estado === "loading" && (
          <div className="glass-panel p-5">
            <div className="mb-2.5 text-xs text-muted-foreground">Recomendación · pronóstico</div>
            <p className="text-sm text-muted-foreground">Calculando recomendación…</p>
          </div>
        )}
        {estado === "error" && (
          <div className="glass-panel p-5">
            <div className="mb-2.5 text-xs text-muted-foreground">Recomendación</div>
            <p className="text-sm text-muted-foreground">Recomendación no disponible ahora.</p>
          </div>
        )}
        {estado === "ok" && data && (
          <>
        ...
        <div className="glass-panel space-y-3 p-4">
          ...
          <p className="text-sm text-muted-foreground">{irrigationHint(last)}</p>
        </div>
